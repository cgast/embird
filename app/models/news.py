...
from sqlalchemy import Column, Integer, String, Text, DateTime, ForeignKey, func, UniqueConstraint, JSON, Index, Float
...
class NewsItem(Base):
    ...
    __table_args__ = (
        UniqueConstraint('topic_id', 'url', name='uix_news_topic_url'),
...
class NewsClusters(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_clusters_topic_hours_similarity', topic_id, hours, min_similarity),
        UniqueConstraint('topic_id', 'hours', 'min_similarity', name='uix_topic_hours_similarity'),
    )
...
class NewsUMAP(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_umap_topic_hours_similarity', topic_id, hours, min_similarity),
        UniqueConstraint('topic_id', 'hours', 'min_similarity', name='uix_umap_topic_hours_similarity'),
    )
